...
const SearchRestaurants = () => {
    ...
    const getSearchItemFoods = async () => {
        const data = await fetch('https://corsproxy.io/?https%3A%2F%2Fwww.swiggy.com%2Fdapi%2Flanding%2FPRE_SEARCH%3Flat%3D12.9715987%26lng%3D77.5945627');
    ...
    const getSearchSuggestions = async () => {
        const data = await fetch('https://corsproxy.io/?'+encodeURIComponent(`https://www.swiggy.com/dapi/restaurants/search/suggest?lat=12.9715987&lng=77.5945627&str=${searchText}&trackingId=undefined`));
    ...
    const getSearchByRes = async () => {
        const data = await fetch('https://corsproxy.io/?'+encodeURIComponent(`https://www.swiggy.com/dapi/restaurants/search/v3?lat=12.9715987&lng=77.5945627&str=${searchName}&trackingId=undefined&submitAction=SUGGESTION&queryUniqueId=bc9bbc65-5d8b-0aa5-bbdc-65b467e6afdb`))
        const json = await data.json();
